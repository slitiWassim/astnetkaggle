...
class ASTNet(nn.Module):
    ...
    def __init__(self, config, pretrained=True):
        ...
        #self.attn0 = ChannelAttention(channels[3])
        ...
        self.conv0 = nn.Conv2d(in_channels=channels[3], 
                                      out_channels=channels[3],
                                      kernel_size=2, 
                                      stride=2,bias=False)
        
        self.conv2 = nn.Conv2d(in_channels=channels[3], 
                                      out_channels=channels[3],
                                      kernel_size=2, 
                                      stride=2,bias=False)
        

        self._pre_vq_conv = nn.Conv2d(in_channels=channels[3], 
                                      out_channels=channels[3],
                                      kernel_size=2, 
                                      stride=2)
    ...
    def forward(self, x):
        ...
        x8 = x8.view(x0_shape[0],-1,embedding_dim) 
    ...
    def compute_loss(self, x):
        ...
        x8 = x8.view(self.batch,-1,embedding_dim) 
